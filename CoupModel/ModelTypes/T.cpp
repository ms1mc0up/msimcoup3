...
T::T(vector<double> *target,NE *pNNE, enum datatype data, enum elements elem, enum fysprocess fproc, enum bioprocess bproc, enum userlevel ulev)
...
void T::Def(size_t ModuleNo, string name, vector<double> init, string unit, string conditions)
{
