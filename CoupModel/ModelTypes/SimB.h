...
enum elements {
	...
	GLOBALRADIATION, LONGWAVEINCOMINGRADIATION, HUMIDITY, GHG, PLANT_BIOMASS , SOILGAS_NO, SOILGAS_N2O
};
...
enum bioprocess{DECOMPOSITION,MINERALISATION, NITRIFICATION, DENITRIFICATION, RESPIRATION, PRODUCTION,OXIDATION, REALLOCATION, PHENOLOGY, SOIL_GAS_DYNAMICS,
	...
	SOIL_GAS_EQUILIBRIUM
};
enum userlevel{SIMPLE, NORMAL, DETAILED};
enum MR_METHOD{LINEAR_CHANGE, LOG_CHANGE, STOCHASTIC_LIN_CHANGE, STOCHASTIC_LOG_CHANGE, TABLE_VAL, DB_RECORD, SAME_AS, REL_SAME_AS, OP_REL_SAME_AS, BAYESIAN_CAL, CONNECTED, BAYESIAN_CAL_LOG};
...
class SimB
	...
	public:
		...
		size_t GetHistoryIndex(size_t index1, size_t index2) {	if(index1<100) return m_HistoryIndex[index1][index2]; return 0; };
