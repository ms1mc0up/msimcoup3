...
FUtil::~FUtil(void)
{
 ...
 string FUtil::GetProfileStringStd(string item, string value) {
 ...
 string FUtil::check_open_newfile(fstream *filestream, string filename) {
	 string fileout;
 ...
 bool FUtil::check_if_empty_file(fstream *filestream, string filename) {
...
string FUtil::NameRevision2018(string name)
{
	...
	if (name.find("C") == 0 && name.find(" ") != 1 && name.find("Tot") != 1 && name.find("Carbon") != 0) {
