...
bool NC_ExternalInputs_Functions::Def()
{
	...
	pXs= new Xs(&N_Fert , SOILSURFACE, NITROGEN, STORAGE, FORCING_BIOLOGY, NORMAL);
		Define(pXs, "N Fertilizer", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >0");
	pTs= new Ts(&N_Fert_App, SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs, "N Fert Appl Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >0");
	pTs= new Ts(&N_Fert_NO3, SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "N Fert NO3 Dis Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >0");
	pTs= new Ts(&N_Fert_NH4, SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "N Fert NH4 Dis Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >0");
	pTs= new Ts(&N_Manure_NH4,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,  	"N Manure NH4 Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0");
	pTs= new Ts(&N_Manure_Litter,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "N Manure Litter Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0");
	pTs= new Ts(&N_Manure_Faeces,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "N Manure Faeces Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0");
	pTs= new Ts(&C_Manure_Litter,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "C Manure Litter Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0");
	pTs= new Ts(&C_Manure_Faeces,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "C Manure Faeces Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0");
	pTs= new Ts(&N_Deposition_NO3,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "Deposition NO3 Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0");
	pTs= new Ts(&N_Deposition_NH4,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pTs,   "Deposition NH4 Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0");
		vector<double> initv;
	pT= new T(&N_Deposition_Leaf, pNumPlants,  SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL);initv.assign(p_Plant->NumPlants,0.); 
		Define(pT, pNumPlants,  "Deposition N Leaf",initv,MASS_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0");
	pGs= new Gs(&Total_N_DepositionLeaf, SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
		Define(pGs,   "Total Deposition N Leaf", 0.0,MASS_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0");
	pGs= new Gs(&N_Irrig_App, SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); 
	    Define(pGs,   "N Irrig Appl Rate", 0.,MASS_UNIT, "Nitrogen and Carbon >= 1|N Irrigation >0");
...
bool NC_ExternalInputs_Functions::FunctionDef()
{
	...
	Define(pP, pNFertDayNo, "N Fert Rate", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1", 0., 100.);
	mTab_Fert.push_back(pP); p_vec.push_back(pP);
	...
	Define(pP, pNFertYearTableNo, "N Fert Rate1", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >3", 0., 100.);
	mTab_Fert_YearTable.push_back(pP); p_vec.push_back(pP);
	...
	Define(pP, pNFertYearTableNo, "N Fert Rate2", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >4", 0., 100.);
	mTab_Fert_YearTable.push_back(pP); p_vec.push_back(pP);
	...
	Define(pP, pNFertYearTableNo, "N Fert Rate3", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|N Fertilization >4", 0., 100.);
	mTab_Fert_YearTable.push_back(pP); p_vec.push_back(pP);
	functorprop.FuncName = MyFunc::N_FERTILIZATION_TABLE_YEAR_3APP;
	pFunc = new Func(SOILSURFACE, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL);
	Define(pFunc, functorprop, funcname, ps_vec, p_vec, plotpar);
	...
	Define(pP, pNFertStageNo, "Yearly N Rate", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1", 0., 100.);
	mTab_FertStage.push_back(pP); p_vec.push_back(pP);
	...
	Define(pP, pNumPlants, "Dep N to Leaf", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0", 0., 0.01);
	...
	Define(pPs, "Dep N DryRate", 0.001, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|N Deposition >0", 0., 0.1);
	...
	Define(pP, pNManureDayNo, "N Faeces", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0", 0., 30.);
	mTab_Manure.push_back(pP);
	pP = new P(&Manure_Litter, pNManureDayNo, ATMBOUNDARY, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); initv.assign(NManureDayNo, 2.);
	Define(pP, pNManureDayNo, "N Litter", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0", 0., 30.);
	mTab_Manure.push_back(pP);
	pP = new P(&Manure_NH4, pNManureDayNo, ATMBOUNDARY, NITROGEN, TRANSPORT, FORCING_BIOLOGY, NORMAL); initv.assign(NManureDayNo, 6.);
	Define(pP, pNManureDayNo, "N NH4", initv, MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|FaecesPool >0", 0., 50.);
	mTab_Manure.push_back(pP);
