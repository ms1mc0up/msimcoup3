...
bool NC_Organic_Functions::Def() {
	...
	pSw= new Sw(&Initial_Soil_Organic,  SIMPROFILE,ORGANIC, TRANSPORT,NOBPROC, NORMAL);
		Define(pSw, "Initial Soil Organic",1,"Table|Linear decrease|Constant|Exponential","Nitrogen and Carbon > 0");
...
//		Define(pTs , "NSurfaceL Humus", 0.,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Microbes >0");


//	pTs= new Ts(&SurfaceLitterMixingIntoUppermostlayer[_H][_C_],  SOILSURFACE,CARBON, TRANSPORT,NOBPROC, NORMAL);
//		Define(pTs , "CSurfaceL Humus", 0.,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Microbes >0");


	/*	pT= new T(&LitterInputToSoilLayers[_L1][_N_],pNL,SIMPROFILE,CARBON, TRANSPORT,LITTERFALL, NORMAL);
	Define(pT, pNL  , "CFungiLitter1",initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Mycorrhiza Fungal Growth>0");
		pT= new T(&LitterInputToSoilLayers[_L1][_N_],pNL,SIMPROFILE,CARBON, TRANSPORT,LITTERFALL, NORMAL);
	Define(pT, pNL  , "CFungiLitter2",initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|LitterPools > 0|Mycorrhiza Fungal Growth>0")	;

		pT= new T(&LitterInputToSoilLayers[_F][_N_],pNL,SIMPROFILE,CARBON, TRANSPORT,LITTERFALL, NORMAL);
	Define(pT, pNL  , "NFungiLitter1",initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Mycorrhiza Fungal Growth>0");
		pT= new T(&LitterInputToSoilLayers[_F][_N_],pNL,SIMPROFILE,CARBON, TRANSPORT,LITTERFALL, NORMAL);
	Define(pT, pNL  , "NFungiLitter2",initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|LitterPools > 0|Mycorrhiza Fungal Growth>0")	;
;*/
// MF;
...
// C Respiration Flow Variables;
	...
	for (size_t j = _L1; j <= _MIC; j++) {
		...
		pGs = new Gs(&O_RespRateProfile[_L1], TOTPROFILE, CARBON, NOFPROC, RESPIRATION, NORMAL);
...
//	Define(pGs CTotDisOrgDecomp,  	"CTotDisOrgDecomp",		0.0,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|DissolvedOrganics >0");
;
//! Auxiliary																										;
/*	pG= new G(&CLitter1Decomp	 ,pNL,SIMPROFILE,CARBON, NOFPROC,DECOMPOSITION, NORMAL);																													;
	Define(pG, pNL  ,	"CLitter1Decomp",	initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Microbes = 0");
	pG= new G(&CLitter2Decomp	 ,pNL,SIMPROFILE,CARBON, NOFPROC,DECOMPOSITION, NORMAL);																													;
		Define(pG, pNL  ,	"CLitter2Decomp",	initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|Microbes = 0|LitterPools >0");
	pG= new G(&CFaecesDecomp	 ,pNL,SIMPROFILE,CARBON, NOFPROC,DECOMPOSITION, NORMAL);																													;
		Define(pG, pNL  ,	"CFaecesDecomp",	initv,MASSFLOW_UNIT, "Nitrogen and Carbon >= 1|FaecesPool > 0");
;*/
