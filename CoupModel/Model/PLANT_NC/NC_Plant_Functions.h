...
double MoistureRangeEmergence, ZadokRangeGSI2;
...
vector<double> T_Sum_Emerg, T_Thres_Emerg, T_Sum_Sowing, T_Thres_Sowing, T_Thres_Dormancy;
...
function<double(size_t, double, double, double)> f_GrowthTemp;
function<double(size_t, double, double, double, double *DormSum, size_t *SpringDev)> f_DormingTemp;
