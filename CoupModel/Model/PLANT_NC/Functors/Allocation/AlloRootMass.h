...
public:
	CAlloRootMass_Linear(vector<double> AlloRootTotMass1, vector<double> AlloRootTotMass2) :a(AlloRootTotMass1), b(AlloRootTotMass2) {}
	double operator() (size_t index, double Mass) {
		return min(0.8, a[index]+b[index]*Mass);
	}
private:
	vector <double> a, b;
};
