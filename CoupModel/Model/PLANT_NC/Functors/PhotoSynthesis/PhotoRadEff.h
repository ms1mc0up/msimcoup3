...
public:
	...
	double operator() (size_t index, double AdsorbedLight) {
...
public:
	...
	double operator() (size_t index, double PhotoSatRed) {
...
public:
	...
	double operator() (size_t index, double DegreeGrainFilling) {
