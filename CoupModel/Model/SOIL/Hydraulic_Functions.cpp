...
bool Hydraulic_Functions::Def()
{
	...
	Define(pPs,"Common value", 10.,WATERFLOW_UNIT,"WaterEq = 1|Matric Conductivity =2", 1.E-03,100.,1.E-4,1000.,1,0,422);
...
//!			"ClayContent|SandContent")
	...
	pTab= new Tab(&mTab_Gen_Model , SIMPROFILE, WATER, STORAGE, NOBPROC, SIMPLE); 	
		Define(pTab, "Genuchten, water retention, model layers",8);
...
bool Hydraulic_Functions::ReCalc() {
	...
	y1 = f_ThetafromWaterFlow(1 ,0.7,.1);


	auto kval = f_CondTheta_Measured(0, 12., 5.);
	auto kval1 = f_CondTheta(1, 12., 5.);
	auto kval2 = f_CondPsi_Measured(0, 60., 5.);
	auto kval3 = f_CondPsi(1, 60., 5.);
	auto kval4 = f_CondThetaFrozen(1, 12, -1., 0.6);
